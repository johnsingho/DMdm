...
public class DormPersonManageAjaxServices
{
    ...
    public string[] ExportImportErrorData()
    {
        ...
        Cache mCache = new Cache((System.Web.HttpContext.Current.Session[TypeManager.User] != null ?
                ((TB_User)System.Web.HttpContext.Current.Session[TypeManager.User]).ADAccount :
                ((TB_SystemAdmin)System.Web.HttpContext.Current.Session[TypeManager.Admin]).Account), (System.Web.HttpContext.Current.Session[TypeManager.User] != null ?
                ((TB_User)System.Web.HttpContext.Current.Session[TypeManager.User]).SiteID :
                ((TB_SystemAdmin)System.Web.HttpContext.Current.Session[TypeManager.Admin]).SiteID) + "dtError");
