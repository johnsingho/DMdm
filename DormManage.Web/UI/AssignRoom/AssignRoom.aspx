<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AssignRoom.aspx.cs" EnableEventValidation="false" Inherits="DormManage.Web.UI.AssignRoom.AssignRoom" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <div class="navigation_wrap">
            <h3 class="nav_left">我的位置： <span id="navigation">房间分配->床位分配</span>
            </h3>
        </div>
                        ...
                        <div class="searchbar">
                            ...
                            <td>
                                <asp:DropDownList ID="ddlDormArea" runat="server" TabIndex="1"></asp:DropDownList>
                                    ...
                                    <th>
                                        <asp:Label ID="lblWorkDayNo" runat="server" Text="工号："></asp:Label>
                                    </th>
                                    <td>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlBedStatus" runat="server">
                                    ...
                                    <td>
                                        <asp:Button ID="Button1" Text="查询床位" runat="server" CssClass="publicBtn" TabIndex="5"
