<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RequiredHandle.aspx.cs" Inherits="DormManage.Web.UI.FlexPlus.RequiredHandle" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function saveComplete(kind) {
            var sUrl = !kind? "RepairDormList.aspx" : "ReissueKeyList.aspx";
        ...
        <div class="wrapper">
            <div class="list">
                <table>
                    <tr>
                        <th>
                            <asp:Label ID="lblHandle" runat="server" Text="审核："></asp:Label>
                        </th>
                        <td>
                            <asp:DropDownList ID="ddlHandle" runat="server" 
                                AutoPostBack="True" OnSelectedIndexChanged="ddlHandle_SelectedIndexChanged" >
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
