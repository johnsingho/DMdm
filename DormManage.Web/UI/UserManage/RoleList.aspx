<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleList.aspx.cs" Inherits="DormManage.Web.UI.UserManage.RoleList" %>
...
<body>
    <form id="form1" runat="server">
        <div class="navigation_wrap">
            <h3 class="nav_left">我的位置： <span id="navigation">用户管理->角色列表</span>
            </h3>
        </div>
        <div class="wrapper">
            <div class="content">
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:Button ID="btnNew" Text="新 增" runat="server" CssClass="newBtn" TabIndex="3" OnClick="btnNew_Click" OnClientClick="return add()"></asp:Button>
                            </td>
                        </tr>
                    </table>
                </div>
