<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AllowanceApplyCancel.aspx.cs" Inherits="DormManage.Web.UI.Allowance.AllowanceApplyCancel" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function importComplete() {
            var url = "/UI/Common/ExcelDownHandler.aspx?action=ImpErrAllowanceAppCancel";
            ...
            if (ajax.error == null) {
                ...
                try {
                    ...
                    $.ligerDialog.warn("Your browser does not support ActiveXObject, please use IE.", "Warn");
                    return;
                }
...
<body>
    ...
    <form id="form1" runat="server">
        <div class="navigation_wrap">
            <h3 class="nav_left">我的位置： <span id="navigation">住房津贴->住房津贴申请取消登记</span>
            </h3>
        </div>
        <div class="wrapper">
            <div class="content">
                                ...
                                <div class="viewlist">
                                    <cc1:GridView ID="GridView1" runat="server" CssClass="form" EmptyDataText="<无结果显示>"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="AllowanceApplyDate" HeaderText="申请津贴时间" />
                                             <asp:BoundField DataField="EmployeeTypeName" HeaderText="工种" />
                                            <asp:BoundField DataField="AllowanceCancelDate" HeaderText="取消申请时间" />
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                          ...
                                          <tr>
                                            <td>&nbsp;</td>
                                            <td class="pageright">
                                                <a href="../../FileTemplate/员工住房津贴取消申请模板.xlsx">Download Template</a>
