<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FloorDefine.aspx.cs" Inherits="DormManage.Web.UI.DormManage.Floor.FloorDefine" EnableEventValidation="false" %>
...
<body>
    <form id="form1" runat="server">
        <div class="navigation_wrap">
            <h3 class="nav_left">我的位置： <span id="navigation">宿舍基本管理->楼层</span>
            </h3>
        </div>
                ...
                <div class="searchbar">
                    <table>
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtFloorName" runat="server" TabIndex="4"></asp:TextBox>
                            </td>
                            <td>
                                <asp:Button ID="btnSearch" Text="查 询" runat="server" class="findBtn" TabIndex="5"
                                    OnClick="btnSearch_Click"></asp:Button>
                                <asp:Button ID="btnNew" Text="新 增" runat="server" class="newBtn" TabIndex="6" OnClick="btnNew_Click" OnClientClick="return add()"></asp:Button>
                            </td>
                        </tr>
                    </table>
                </div>
                                ...
                                <div class="viewlist">
                                    <cc1:GridView ID="GridView1" runat="server" CssClass="form" EmptyDataText="<无结果显示>"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Name" HeaderText="楼层" />
                                        </Columns>
                                    </cc1:GridView>
                                </div>
                                <div class="pagerbar">
