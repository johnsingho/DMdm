<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="MonthDormInfo.aspx.cs" Inherits="DormManage.Web.UI.Report.MonthDormInfo" %>
                    ...
                    <table>
                        ...
                        <tr >
                            ...
                            <td>
                                ...
                                <asp:TextBox ID="txtStartDay" runat="server" onclick="WdatePicker({dateFmt:'yyyy-MM'})"></asp:TextBox>
                            </td>
