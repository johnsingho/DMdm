...
{
    public partial class DayDormInfo : BasePage
    {
        ...
        private void Bind(int intCurrentIndex)
        {
            ...
            DataTable dt = mRoomBLL.GetDayDormInfoBySiteIDEX(2, txtStartDay.Text,txtEndDay.Text);
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                txtStartDay.Text = System.DateTime.Now.AddDays(-7).ToString("yyyy-MM-dd");
                txtEndDay.Text = System.DateTime.Now.ToString("yyyy-MM-dd");
                this.ddlBind();
                //this.Bind(1);
            }
        }
